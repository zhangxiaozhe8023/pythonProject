...
class SendMail(object):
    def __init__(self, email_info):
        ...
        # 使用SMTP_SSL连接端口为465
        self.smtp = smtplib.SMTP_SSL(self.email_info['smtp.qq.com'], self.email_info['465'])
        # 创建两个变量
        self._attachements = []
        self._from = ''
    ...
    def login(self):
        # 通过邮箱名和smtp授权码登录到邮箱
        self._from = self.email_info['980778026@qq.com']
        self.smtp.login(self.email_info['980778026@qq.com'], self.email_info['mmfrcjqfhqhebcfi'])
...
if __name__ == '__main__':
    ...
    liu_url = "http://192.168.1.6:8666/student2Recoder/getClassUseRecoder.action"
    project = ".6加分统计接口"
